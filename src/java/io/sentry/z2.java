...
public final class z2 implements x2
{
    ...
    public t2 a(final m0 m0, final q4 q4) {
        ...
        if (a != null && this.b(a, q4.getLogger())) {
            return this.c(new h2(m0, q4.getEnvelopeReader(), q4.getSerializer(), q4.getLogger(), q4.getFlushTimeoutMillis()), a, q4.getLogger());
        }
        q4.getLogger().a(l4.ERROR, "No outbox dir path is defined in options.", new Object[0]);
        return null;
    }
